...
////// Lighting:
                ...
                float3 finalColor = (lerp(_Shadowcolor.rgb,(_Lightcolor.rgb*_LightColor0.rgb*attenuation),node_3029)*saturate(( (node_3029+_Grunge_var.rgb) > 0.5 ? (node_3029/((1.0-(node_3029+_Grunge_var.rgb))*2.0)) : (1.0-(((1.0-node_3029)*0.5)/(node_3029+_Grunge_var.rgb))))));
